<template>
  <div class="parent">
    <div id="confirmation">
      <nav>
        <i class="far fa-file-alt"></i>以下の内容をご確認ください
      </nav>
    ...
    <router-link to="/consultation" class="button colum is-primary">＜ 前へ戻る</router-link>
    <span class="button colum is-primary">送信 ＞</span>
  </div>
</template>
<script>
export default {
